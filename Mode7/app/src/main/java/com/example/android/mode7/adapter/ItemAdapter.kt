...
class ItemAdapter(
    ...
    class ItemViewHolder(private val view: View, private val onItemTouched: (position: Int) -> Unit) : RecyclerView.ViewHolder(view), View.OnTouchListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        return ItemViewHolder(adapterLayout, onItemTouched)
    }
